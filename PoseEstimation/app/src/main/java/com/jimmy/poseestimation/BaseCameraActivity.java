...
import com.jimmy.poseestimation.R;
...
public abstract class BaseCameraActivity extends AppCompatActivity implements OnImageAvailableListener {
    ...
    protected void setFragment() {
        ...
        final ai.fritz.camera.CameraConnectionFragment fragment =
                ai.fritz.camera.CameraConnectionFragment.newInstance(
                        new ai.fritz.camera.CameraConnectionFragment.ConnectionCallback() {
                            @Override
    ...
    public void requestRender() {
        final ai.fritz.camera.OverlayView overlay = (ai.fritz.camera.OverlayView) findViewById(R.id.debug_overlay);
        if (overlay != null) {
            overlay.postInvalidate();
        }
    }

    public void setCallback(final ai.fritz.camera.OverlayView.DrawCallback callback) {
        final ai.fritz.camera.OverlayView overlay = findViewById(R.id.debug_overlay);
        if (overlay != null) {
