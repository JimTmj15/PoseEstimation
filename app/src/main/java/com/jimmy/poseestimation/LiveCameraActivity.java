...
import com.jimmy.poseestimation.MainActivity;
import com.jimmy.poseestimation.R;


public abstract class LiveCameraActivity extends ai.fritz.camera.BaseCameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    public void onPreviewSizeChosen(final Size previewSize, final Size cameraViewSize, final int rotation) {
        ...
        setCallback(
                new ai.fritz.camera.OverlayView.DrawCallback() {
                    @Override
